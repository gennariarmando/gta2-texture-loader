workspace "gta2-texture-loader"
	configurations { "ReleaseII", "DebugII" }
	location "project_files"
   
project "gta2-texture-loader"
	kind "SharedLib"
	language "C++"
	...
	filter { "configurations:*II" }	
		...
		targetname "TextureLoaderII"
		debugdir "$(GTA_II_DIR)"
		debugcommand "$(GTA_II_DIR)/gta2.exe"
		postbuildcommands "copy /y \"$(TargetPath)\" \"$(GTA_II_DIR)\\scripts\\TextureLoaderII.asi\""
